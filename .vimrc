...
set laststatus=2
" Use 256 colours (Use this setting only of your terminal supports 256 colours)
set t_Co=256

" Fix indention for bash scripts
...
" Fix indention for python scripts
autocmd BufNewFile,BufRead *.py set shiftwidth=4
autocmd BufNewFile,BufRead *.py set tabstop=4
autocmd BufNewFile,BufRead *.py set softtabstop=4

" Fix indention for perl scripts
...
" Fix indention for .conf files
autocmd BufNewFile,BufRead *.conf set shiftwidth=4
autocmd BufNewFile,BufRead *.conf set tabstop=4
autocmd BufNewFile,BufRead *.conf set softtabstop=4
